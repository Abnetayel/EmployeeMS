...
namespace WebApplication3
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Salary");
            if (labelColumn == null)
            {
                throw new Exception("Salary column not found. Make sure the name searched for matches the name in the schema.");
            }
